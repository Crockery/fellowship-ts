...
export const Meiko: Hero = {
  ...
  stats: {
    ...
    WeaponDamageMax: 0,
    Strength: 0,
    StaminaToMaxHealthMultiplier: 61.771,
    Stamina: 1000,
    SpiritRefundChanceScale: 1,
    SpiritPoints: 0,
    SpiritGenerationHeal: 0.02,
    SpiritGenerationDamage: 0.05,
    Spirit: 0,
    ResourcesSecond: 0,
    Resources: 100,
    Resist: 0,
    ...
    HealthRegenRate: 0,
    HealThreatMultiplier: 0.75,
    Haste: 1,
    Expertise: 0,
    DodgeChance: 0.05,
    DamageThreatMultiplier: 9,
    CritMultiplier: 2,
    CritChance: 0.05,
    CooldownRecovery: 1,
    BlockChance: 0,
