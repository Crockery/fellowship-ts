...
export const Mosse: Hero = {
  ...
  stats: {
    ResourcesTertiary: 4,
    MaxResourcesTertiary: 4,
    ParryChance: 0,
    WeaponDamageMin: 0,
    WeaponDamageMax: 0,
    Strength: 0,
    StaminaToMaxHealthMultiplier: 39.978,
    Stamina: 1000,
    SpiritRefundChanceScale: 1,
    SpiritPoints: 0,
    SpiritGenerationHeal: 0.04,
    SpiritGenerationDamage: 0.04,
    Spirit: 0,
    ResourcesSecond: 0,
    Resources: 100,
    Resist: 0,
    ...
    Power: 0,
    PassiveMoveSpeed: 1,
    OutOfCombatManaRegenTickTime: 0.1,
    OutOfCombatManaRegenRate: 0.0036,
    ...
    MaxResources: 100,
    MaxMana: 1440,
    ManaRegenTickTime: 0.1,
    ManaRegenRate: 0.0005,
    Mana: 1440,
    LifeSteal: 0,
    Intellect: 1000,
